...
export default function Tasks({ set_show_delete_model, set_open_edit_model, set_task_info, set_updated_task }) {
  ...
  tasksLoader = tasks_to_be_rendered.map((task) => (
    <Task set_updated_task={set_updated_task} set_show_delete_model={set_show_delete_model} set_task_info={set_task_info} set_open_edit_model={set_open_edit_model} key={task.id} task={task} />
  ));
